...
bool Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/silk"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Silk Core"),
     ...
     * override -datadir in the silk.conf file in the default data directory
     * (to be consistent with silkd behavior)
     */
    if(dataDir != getDefaultDataDirectory())

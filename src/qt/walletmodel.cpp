...
WalletModel::WalletModel(CWallet *wallet, OptionsModel *optionsModel, QObject *parent) :
    ...
    cachedBalance(0), cachedTotal(0), cachedStake(0), cachedUnconfirmedBalance(0), cachedImmatureBalance(0),
...
WalletModel::SendCoinsReturn WalletModel::prepareTransaction(WalletModelTransaction &transaction, int nSplitBlock, const CCoinControl *coinControl)
{
...

    {
        ...
        bool fCreated = wallet->CreateTransaction(vecSend, *newTx, *keyChange, nFeeRequired, nSplitBlock, strFailReason, coinControl);
